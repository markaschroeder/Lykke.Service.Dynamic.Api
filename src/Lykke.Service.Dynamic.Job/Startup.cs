...
using Lykke.Service.Dynamic.Job.Modules;
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                {
                    options.DefaultLykkeConfiguration("v1", "Dynamic.Job");
                ...
                builder.RegisterModule(new JobModule(appSettings.Nested(x => x.DynamicJob), Log));
